...
def train(exp_num,model,device,max_epochs,val_interval,num_segments,data,loss_function,optimizer,dice_metric):
    ...
    for epoch in range(max_epochs):
        ...
        #         # aggregate the final mean dice result
                ...
                if metric > best_metric:
                    ...
                    torch.save(state, f"model_experiment_{exp_num}.pth.tr")
